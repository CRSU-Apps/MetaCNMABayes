...
#include "stanExports_continuous_fe.h"

RCPP_MODULE(stan_fit4continuous_fe_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_continuous_fe")
