...
public:
  ...
  inline std::string model_name() const final { return "model_binary_fe"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_binary_fe(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_binary_fe_namespace::model_binary_fe";
    ...
    try {
      ...
      validate_non_negative_index("r", "n_trials", n_trials);
      current_statement__ = 29;
      validate_non_negative_index("r", "max(n_arms)", max(n_arms));
      current_statement__ = 30;
      context__.validate_dims("data initialization","r","int",
          context__.to_vec(n_trials, max(n_arms)));
      r = std::vector<std::vector<int>>(n_trials, std::vector<int>(max(
                                                                    n_arms), std::numeric_limits<int>::min()));
      
      {
        std::vector<int> r_flat__;
        current_statement__ = 30;
        assign(r_flat__, nil_index_list(), context__.vals_i("r"),
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_binary_fe_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      d = in__.vector(n_components);
      {
        ...
        validate_non_negative_index("p", "n_trials", n_trials);
        current_statement__ = 4;
        validate_non_negative_index("p", "max(n_arms)", max(n_arms));
        std::vector<Eigen::Matrix<local_scalar_t__, -1, 1>> p;
        p = std::vector<Eigen::Matrix<local_scalar_t__, -1, 1>>(n_trials, Eigen::Matrix<local_scalar_t__, -1, 1>(
          max(n_arms)));
                  ...
                  to_vector(
                    rvalue(components,
                      cons_list(index_omni(),
                        cons_list(index_uni(i),
                          cons_list(index_uni(k), nil_index_list()))),
                      "components")))), "assigning variable p");
            current_statement__ = 16;
            lp_accum__.add(
              binomial_logit_lpmf<propto__>(r[(i - 1)][(k - 1)],
                n[(i - 1)][(k - 1)], p[(i - 1)][(k - 1)]));}}
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_binary_fe_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
