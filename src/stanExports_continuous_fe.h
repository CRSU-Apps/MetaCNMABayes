...
static constexpr std::array<const char*, 43> locations_array__ =
  ...
  " (in 'continuous_fe', line 40, column 6 to column 63)",
...
public:
  ~model_continuous_fe() {}
  model_continuous_fe(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_continuous_fe_namespace::model_continuous_fe";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_continuous_fe_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
            ...
            Eigen::Matrix<local_scalar_t__,-1,1>>(n_components);
      {
        ...
        stan::math::validate_non_negative_index("prec", "n_trials", n_trials);
        current_statement__ = 7;
        stan::math::validate_non_negative_index("prec", "max(n_arms)",
          stan::math::max(n_arms));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_continuous_fe_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
