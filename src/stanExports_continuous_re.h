...
static constexpr std::array<const char*, 77> locations_array__ =
  ...
  " (in 'continuous_re', line 20, column 2 to column 30)",
  " (in 'continuous_re', line 22, column 2 to column 31)",
  " (in 'continuous_re', line 23, column 2 to column 39)",
  " (in 'continuous_re', line 26, column 2 to column 35)",
  " (in 'continuous_re', line 27, column 2 to column 36)",
  " (in 'continuous_re', line 28, column 2 to column 36)",
  " (in 'continuous_re', line 29, column 2 to column 38)",
  " (in 'continuous_re', line 30, column 2 to column 41)",
  " (in 'continuous_re', line 32, column 4 to column 16)",
  " (in 'continuous_re', line 33, column 4 to column 22)",
  " (in 'continuous_re', line 34, column 4 to column 16)",
  " (in 'continuous_re', line 35, column 4 to column 16)",
  " (in 'continuous_re', line 36, column 4 to column 18)",
  " (in 'continuous_re', line 38, column 6 to column 39)",
  " (in 'continuous_re', line 39, column 6 to column 98)",
  " (in 'continuous_re', line 40, column 6 to column 40)",
  " (in 'continuous_re', line 41, column 6 to column 96)",
  " (in 'continuous_re', line 42, column 6 to column 32)",
  " (in 'continuous_re', line 37, column 27 to line 43, column 5)",
  " (in 'continuous_re', line 37, column 4 to line 43, column 5)",
  " (in 'continuous_re', line 45, column 6 to column 17)",
  " (in 'continuous_re', line 46, column 6 to column 18)",
  " (in 'continuous_re', line 47, column 6 to column 18)",
  " (in 'continuous_re', line 48, column 6 to column 20)",
  " (in 'continuous_re', line 49, column 6 to column 23)",
  " (in 'continuous_re', line 44, column 41 to line 50, column 5)",
  " (in 'continuous_re', line 44, column 4 to line 50, column 5)",
  " (in 'continuous_re', line 31, column 24 to line 51, column 3)",
  " (in 'continuous_re', line 31, column 2 to line 51, column 3)",
  " (in 'continuous_re', line 55, column 29 to column 37)",
  " (in 'continuous_re', line 55, column 10 to column 21)",
  " (in 'continuous_re', line 55, column 2 to column 39)",
  " (in 'continuous_re', line 56, column 2 to column 23)",
  " (in 'continuous_re', line 58, column 4 to column 28)",
  " (in 'continuous_re', line 59, column 4 to column 31)",
  " (in 'continuous_re', line 61, column 6 to column 46)",
  " (in 'continuous_re', line 60, column 27 to line 62, column 5)",
  " (in 'continuous_re', line 60, column 4 to line 62, column 5)",
  " (in 'continuous_re', line 64, column 6 to column 40)",
  " (in 'continuous_re', line 65, column 6 to column 63)",
  " (in 'continuous_re', line 63, column 26 to line 66, column 5)",
  " (in 'continuous_re', line 63, column 4 to line 66, column 5)",
  " (in 'continuous_re', line 57, column 24 to line 67, column 3)",
  " (in 'continuous_re', line 57, column 2 to line 67, column 3)",
  ...
  " (in 'continuous_re', line 20, column 14 to column 26)",
  " (in 'continuous_re', line 23, column 29 to column 37)",
  " (in 'continuous_re', line 23, column 10 to column 21)",
  " (in 'continuous_re', line 26, column 25 to column 33)",
  " (in 'continuous_re', line 26, column 10 to column 21)",
  " (in 'continuous_re', line 27, column 26 to column 34)",
  " (in 'continuous_re', line 27, column 10 to column 21)",
  " (in 'continuous_re', line 28, column 26 to column 34)",
  " (in 'continuous_re', line 28, column 10 to column 21)",
  " (in 'continuous_re', line 29, column 28 to column 36)",
  " (in 'continuous_re', line 29, column 10 to column 21)",
  " (in 'continuous_re', line 30, column 31 to column 39)",
...
public:
  ~model_continuous_re() {}
  model_continuous_re(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_continuous_re_namespace::model_continuous_re";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      stan::math::validate_non_negative_index("y", "n_trials", n_trials);
      current_statement__ = 54;
      stan::math::validate_non_negative_index("y", "max(n_arms)",
        stan::math::max(n_arms));
      current_statement__ = 55;
      context__.validate_dims("data initialization", "y", "double",
        std::vector<size_t>{static_cast<size_t>(n_trials),
          static_cast<size_t>(stan::math::max(n_arms))});
      y = std::vector<std::vector<double>>(n_trials,
      ...
      stan::math::validate_non_negative_index("sd", "n_trials", n_trials);
      current_statement__ = 57;
      stan::math::validate_non_negative_index("sd", "max(n_arms)",
        stan::math::max(n_arms));
      current_statement__ = 58;
      context__.validate_dims("data initialization", "sd", "double",
        std::vector<size_t>{static_cast<size_t>(n_trials),
          static_cast<size_t>(stan::math::max(n_arms))});
      sd = std::vector<std::vector<double>>(n_trials,
             std::vector<double>(stan::math::max(n_arms),
               std::numeric_limits<double>::quiet_NaN()));
      {
        std::vector<local_scalar_t__> sd_flat__;
        current_statement__ = 58;
        sd_flat__ = context__.vals_r("sd");
        current_statement__ = 58;
        pos__ = 1;
        current_statement__ = 58;
        for (int sym1__ = 1; sym1__ <= stan::math::max(n_arms); ++sym1__) {
          ...
          for (int sym2__ = 1; sym2__ <= n_trials; ++sym2__) {
            current_statement__ = 58;
            stan::model::assign(sd, sd_flat__[(pos__ - 1)],
              "assigning variable sd", stan::model::index_uni(sym2__),
              stan::model::index_uni(sym1__));
            current_statement__ = 58;
            pos__ = (pos__ + 1);
          }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_continuous_re_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      }
      {
        ...
        stan::math::validate_non_negative_index("theta", "n_trials", n_trials);
        current_statement__ = 32;
        stan::math::validate_non_negative_index("theta", "max(n_arms)",
          stan::math::max(n_arms));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_continuous_re_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
